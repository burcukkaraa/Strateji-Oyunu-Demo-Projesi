...
public class bilgi_santral : MonoBehaviour, IPointerClickHandler
{
    ...
    void Start()
    {
        ...
        Button_santral = this.GetComponent<Button>();
    ...
    public void OnPointerClick(PointerEventData tiklandi)
    {
        ((IPointerClickHandler)Button_santral).OnPointerClick(tiklandi);
        Debug.Log(" IPointerClickHandler calisti santral tiklandi");

        Image_bilgi_gorsel_santral.enabled = true;
        Text_bilgi_santral.enabled = true;
